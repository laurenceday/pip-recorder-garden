...
- The production build emitted 235.62 kB of JavaScript (73.62 kB gzip) and 21.24 kB of CSS (5.51 kB gzip). The JavaScript total was 235618 bytes, below the 300000-byte ceiling.
